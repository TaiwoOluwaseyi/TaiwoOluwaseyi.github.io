...
<div class="certificates" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(60px, 1fr)); gap: 10px; align-items: center;">
  <img src="/myfolder/sec+image.webp" alt="Comptia Security+" style="max-width: 50px; min-height: 100px;"> 
  <img src="/myfolder/Sc900Image.webp" alt="SC-900" style="max-width: 50px; min-height: 100px;">
  <img src="/myfolder/ISC2logo.webp" alt="ISC2" style="max-width: 50px; min-height: 100px;">
  <img src="/myfolder/google cybersecurity course image.webp" alt="Google Cybersecurity" style="max-width: 50px; min-height: 100px;">
  <img src="/myfolder/isocert.png" alt="ISO Certificate" style="max-width: 50px; min-height: 100px;">
</div>
